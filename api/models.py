...
class PredictionRequest(BaseModel):
    ...
    sepal_length: float = Field(
        ...
        ge=0.0, 
        le=10.0,
        description="Sepal length in centimeters (0-10 cm range)"
    )
    sepal_width: float = Field(
        ..., 
        ge=0.0, 
        le=10.0,
        description="Sepal width in centimeters (0-10 cm range)"
    )
    petal_length: float = Field(
        ..., 
        ge=0.0, 
        le=10.0,
        description="Petal length in centimeters (0-10 cm range)"
    )
    petal_width: float = Field(
        ..., 
        ge=0.0, 
        le=10.0,
        description="Petal width in centimeters (0-10 cm range)"
    )
...
class BatchPredictionResponse(BaseModel):
    ...
    total_processing_time_ms: float = Field(..., description="Total processing time for the batch")
...
class ModelInfoResponse(BaseModel):
    ...
    training_date: Optional[datetime] = Field(None, description="When the model was trained")
