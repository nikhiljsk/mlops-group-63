...
if __name__ == "__main__":
    ...
    lr_model, lr_metrics = train_and_log_model(lr_model, X_train, X_test, y_train, y_test, "LogisticRegression")

    # Train Random Forest
    rf_model = RandomForestClassifier()
    rf_model, rf_metrics = train_and_log_model(rf_model, X_train, X_test, y_train, y_test, "RandomForest")
