...
class ModelEvaluator:
    ...
    def evaluate_single_model(self, model, X_test, y_test, X_train=None, y_train=None) -> Dict[str, Any]:
        """
        ...
        # Per-class metrics
        class_report = classification_report(y_test, y_pred, output_dict=True, target_names=self.class_names)
        ...
        if y_pred_proba is not None:
            try:
                ...
                metrics['roc_auc_macro'] = roc_auc_score(y_test, y_pred_proba, multi_class='ovr', average='macro')
            except Exception as e:
                print(f"Could not calculate ROC AUC: {e}")
        
        return metrics
    
    def compare_models(self, models_dict: Dict[str, Any], X_test, y_test, X_train=None, y_train=None) -> Dict[str, Any]:
        """
        ...
        summary_metrics = ['accuracy', 'f1_weighted', 'precision_weighted', 'recall_weighted']
        ...
        for metric in summary_metrics:
            summary[metric] = {
                name: results[metric] for name, results in comparison_results.items()
    ...
    def save_evaluation_results(self, results: Dict[str, Any], output_dir: str = "artifacts"):
    ...
    def plot_confusion_matrix(self, confusion_matrix, model_name: str, save_path: str = None):
...
def evaluate_iris_models(models_dict: Dict[str, Any], X_train, X_test, y_train, y_test) -> Dict[str, Any]:
    """
